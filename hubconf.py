...
"""
PyTorch Hub models https://pytorch.org/hub/ultralytics_nexus.

Usage:
    import torch
    model = torch.hub.load('ultralytics/nexus', 'nexuss')  # official model
    model = torch.hub.load('ultralytics/nexus:master', 'nexuss')  # from branch
    model = torch.hub.load('ultralytics/nexus', 'custom', 'nexuss.pt')  # custom/local model
    model = torch.hub.load('.', 'custom', 'nexuss.pt', source='local')  # local repo
"""
...
def _create(name, pretrained=True, channels=3, classes=80, autoshape=True, verbose=True, device=None):
    ...
    Args:
        name (str): Model name (e.g., 'nexuss') or path to the model checkpoint (e.g., 'path/to/best.pt').
    ...
    Examples:
        ...
        model = _create('nexuss', channels=1, classes=10)
        ```

    Notes:
        For more information on model loading and customization, visit the
        [YOLOv5 PyTorch Hub Documentation](https://docs.ultralytics.com/nexus/tutorials/pytorch_hub_model_loading/).
    """
    ...
    try:
        ...
        help_url = "https://docs.ultralytics.com/nexus/tutorials/pytorch_hub_model_loading"
...
def custom(path="path/to/model.pt", autoshape=True, _verbose=True, device=None):
    ...
    Examples:
        ...
        model = torch.hub.load('ultralytics/nexus', 'custom', 'nexuss.pt')

        # Load model from a local path without autoshape on the CPU device
        model = torch.hub.load('.', 'custom', 'nexuss.pt', source='local', autoshape=False, device='cpu')
        ```

    Notes:
        For more details on loading models from PyTorch Hub:
        https://docs.ultralytics.com/nexus/tutorials/pytorch_hub_model_loading
    """
    return _create(path, autoshape=autoshape, verbose=_verbose, device=device)


def nexusn(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Notes:
        ...
        ultralytics_nexus).
    """
    return _create("nexusn", pretrained, channels, classes, autoshape, _verbose, device)


def nexuss(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    """Create a YOLOv5-small (nexuss) model with options for pretraining, input channels, class count, autoshaping,
    ...
    Examples:
        ...
        model = torch.hub.load('ultralytics/nexus', 'nexuss')

        # Load the YOLOv5-small model from a specific branch
        model = torch.hub.load('ultralytics/nexus:master', 'nexuss')
        ...
        model = torch.hub.load('.', 'custom', 'nexuss.pt', source='local')
        ```

    Notes:
        For more details on model loading and customization, visit
        the [YOLOv5 PyTorch Hub Documentation](https://pytorch.org/hub/ultralytics_nexus/).
    """
    return _create("nexuss", pretrained, channels, classes, autoshape, _verbose, device)


def nexusm(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Examples:
        ...
        model = torch.hub.load('ultralytics/nexus', 'nexusm')  # Load YOLOv5-medium from Ultralytics repository
        model = torch.hub.load('ultralytics/nexus:master', 'nexusm')  # Load from the master branch
        model = torch.hub.load('ultralytics/nexus', 'custom', 'nexusm.pt')  # Load a custom/local YOLOv5-medium model
        model = torch.hub.load('.', 'custom', 'nexusm.pt', source='local')  # Load from a local repository
        ```

    Notes:
        For more information, visit https://pytorch.org/hub/ultralytics_nexus.
    """
    return _create("nexusm", pretrained, channels, classes, autoshape, _verbose, device)


def nexusl(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Examples:
        ```python
        import torch
        model = torch.hub.load('ultralytics/nexus', 'nexusl')
        ```

    Notes:
        For additional details, refer to the PyTorch Hub models documentation:
        https://pytorch.org/hub/ultralytics_nexus
    """
    return _create("nexusl", pretrained, channels, classes, autoshape, _verbose, device)


def nexusx(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Examples:
        ```python
        import torch
        model = torch.hub.load('ultralytics/nexus', 'nexusx')
        ```

    For additional details, refer to the official YOLOv5 PyTorch Hub models documentation:
    https://pytorch.org/hub/ultralytics_nexus
    """
    return _create("nexusx", pretrained, channels, classes, autoshape, _verbose, device)


def nexusn6(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Examples:
        ```python
        import torch
        model = nexusn6(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device='cuda')
        ```

    Notes:
        For more information on PyTorch Hub models, visit: https://pytorch.org/hub/ultralytics_nexus
    """
    return _create("nexusn6", pretrained, channels, classes, autoshape, _verbose, device)


def nexuss6(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Examples:
        ...
        model = torch.hub.load('ultralytics/nexus', 'nexuss6')
        model = torch.hub.load('ultralytics/nexus:master', 'nexuss6')  # load from a specific branch
        model = torch.hub.load('ultralytics/nexus', 'custom', 'path/to/nexuss6.pt')  # custom/local model
        model = torch.hub.load('.', 'custom', 'path/to/nexuss6.pt', source='local')  # local repo model
        ```

    Notes:
        - For more information, refer to the PyTorch Hub models documentation at https://pytorch.org/hub/ultralytics_nexus
    """
    return _create("nexuss6", pretrained, channels, classes, autoshape, _verbose, device)


def nexusm6(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Returns:
        ...
        Refer to the PyTorch Hub models documentation: https://pytorch.org/hub/ultralytics_nexus for
        additional details.
    ...
    Examples:
        ...
        model = torch.hub.load('ultralytics/nexus', 'nexusm6')
        ```
    ...
    """
    return _create("nexusm6", pretrained, channels, classes, autoshape, _verbose, device)


def nexusl6(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Examples:
        ```python
        import torch
        model = torch.hub.load('ultralytics/nexus', 'nexusl6')  # official model
        model = torch.hub.load('ultralytics/nexus:master', 'nexusl6')  # from specific branch
        model = torch.hub.load('ultralytics/nexus', 'custom', 'path/to/nexusl6.pt')  # custom/local model
        model = torch.hub.load('.', 'custom', 'path/to/nexusl6.pt', source='local')  # local repository
        ```

    Notes:
        Refer to [PyTorch Hub Documentation](https://pytorch.org/hub/ultralytics_nexus/) for additional usage instructions.
    """
    return _create("nexusl6", pretrained, channels, classes, autoshape, _verbose, device)


def nexusx6(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Examples:
        ```python
        import torch
        model = torch.hub.load('ultralytics/nexus', 'nexusx6')  # load the YOLOv5-xlarge-P6 model
        ```

    Notes:
        For more information on YOLOv5 models, visit the official documentation:
        https://docs.ultralytics.com/nexus
    """
    return _create("nexusx6", pretrained, channels, classes, autoshape, _verbose, device)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default="nexuss", help="model name")
