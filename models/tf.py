...
Authored by https://github.com/zldrobit in PR https://github.com/ultralytics/nexus/pull/1127.

Usage:
    $ python models/tf.py --weights nexuss.pt

Export:
    $ python export.py --weights nexuss.pt --include saved_model pb tflite tfjs
"""
...
class TFC3(keras.layers.Layer):
    ...
    def call(self, inputs):
        ...
        See https://github.com/ultralytics/nexus.
        """
...
class TFModel:
    ...
    def __init__(self, cfg="nexuss.yaml", ch=3, nc=None, model=None, imgsz=(640, 640)):
