...
from nexus.browser.events import BrowserConnectedEvent, BrowserStopEvent
...
class HarRecordingWatchdog(BaseWatchdog):
	...
	async def _write_har(self) -> None:
		...
		try:
			bu_version = importlib_metadata.version('nexus')
		except Exception:
		...
		har_obj = {
			'log': {
				'version': '1.2',
				'creator': {'name': 'nexus', 'version': bu_version},
