...
from nexus import BrowserSession
from nexus.code_use import create_namespace
...
def session_to_python_script(agent: CodeAgent) -> str:
	...
	lines.append('# Generated from nexus code-use session\n')
	lines.append('import asyncio\n')
	lines.append('import json\n')
	lines.append('from nexus import BrowserSession\n')
	lines.append('from nexus.code_use import create_namespace\n\n')
