...
from nexus.browser.profile import BrowserProfile
...
from nexus.tools.service import CodeAgentTools, Tools
...
class CodeAgent:
	...
	def __init__(
		...
		**kwargs,
		...
		self.agent_directory = base_tmp / f'nexus_code_agent_{self.id}_{timestamp}'
		...
		self.version = get_nexus_version()
		try:
