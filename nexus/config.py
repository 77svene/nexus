"""Configuration system for nexus with automatic migration support."""
...
class OldConfig:
	...
	def BROWSER_USE_CLOUD_API_URL(self) -> str:
		url = os.getenv('BROWSER_USE_CLOUD_API_URL', 'https://api.nexus.com')
...
class FlatEnvConfig(BaseSettings):
	...
	BROWSER_USE_CLOUD_API_URL: str = Field(default='https://api.nexus.com')
...
def load_nexus_config() -> dict[str, Any]:
	"""Load nexus configuration for MCP components."""
