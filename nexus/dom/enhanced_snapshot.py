"""
Enhanced snapshot processing for nexus DOM tree extraction.
...
from nexus.dom.views import DOMRect, EnhancedSnapshotNode
...
def build_snapshot_lookup(
	...
	logger = logging.getLogger('nexus.dom.enhanced_snapshot')
