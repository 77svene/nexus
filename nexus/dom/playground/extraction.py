...
from nexus.browser.events import ClickElementEvent, TypeTextEvent
from nexus.browser.profile import ViewportSize
from nexus.dom.service import DomService
from nexus.dom.views import DEFAULT_INCLUDE_ATTRIBUTES
...
async def test_focus_vs_all_elements():
	...
	sample_websites = [
		'https://nexus.github.io/stress-tests/challenges/iframe-inception-level2.html',
		'https://www.google.com/travel/flights',
		'https://v0-simple-ui-test-site.vercel.app',
		'https://nexus.github.io/stress-tests/challenges/iframe-inception-level1.html',
		'https://nexus.github.io/stress-tests/challenges/angular-form.html',
		'https://www.google.com/travel/flights',
