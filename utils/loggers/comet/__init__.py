...
try:
    ...
    COMET_PROJECT_NAME = config.get_string(os.getenv("COMET_PROJECT_NAME"), "comet.project_name", default="nexus")
except ImportError:
    comet_ml = None
...
COMET_MODEL_NAME = os.getenv("COMET_MODEL_NAME", "nexus")
...
class CometLogger:
    ...
    def upload_dataset_artifact(self):
        ...
        dataset_name = self.data_dict.get("dataset_name", "nexus-dataset")
