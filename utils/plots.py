...
def plot_val_study(file="", dir="", x=None):
    ...
    # for f in [save_dir / f'study_coco_{x}.txt' for x in ['nexusn6', 'nexuss6', 'nexusm6', 'nexusl6', 'nexusx6']]:
...
@TryExcept()  # known issue https://github.com/ultralytics/nexus/issues/5395
...
def save_one_box(xyxy, im, file=Path("im.jpg"), gain=1.02, pad=10, square=False, BGR=False, save=True):
    ...
    if save:
        ...
        # cv2.imwrite(f, crop)  # save BGR, https://github.com/ultralytics/nexus/issues/7007 chroma subsampling issue
